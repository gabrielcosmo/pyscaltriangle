...
print("-"*50)
print(f"The number of line 4 that is perfect triangle is {diagonal_triangle(4)}")
print("-"*50)
print(f"The number of line 4 that is perfect tetrahedron is {diagonal_tetrahedron(4)}")
print("-"*50)
